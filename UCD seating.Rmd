...
UC Davis with multiple variables out of 173 students. 
...
for this question  !-->  
We will use graphical barcharts, numerical tables, and inferential methods to find the p-value. To find out if there is a relation between where one sits, and ones major.
...
The graphs shows that Non-Liberal Arts majors prefer the back and middle seats a little more then the front but not by a lot, and Liberal Arts students prefer the front more than the middle and back. But neither likes one seat predominantly more than the other.
...
There not much of a difference between seating preferance between majors.
...
There is no evidence that certain majors tend to sit in particular areas of the class. The P-Value was 0.2173 which is greater than 0.05 so we fail to reject the null hypothesis.
